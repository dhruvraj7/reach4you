...
export default function Contact() {
  ...
  const [formData, setFormData] = useState({
    ...
    workEmail: '',
    companyName: '',
    selectedPackage: 'Starter Reddit Campaign ($400 Per Campaign)',
    additionalNotes: ''
  });
  ...
  const handleSubmit = (e) => {
    ...
    const subject = encodeURIComponent(`Campaign Request: ${formData.companyName} (${formData.fullName})`);
  ...
  const howItWorksSteps = [
    ...
    { num: '②', title: 'Choose your package', desc: 'Select Starter ($400), Growth ($600), or Enterprise ($1000).' },
          ...
          <Card hover={false} className="p-8 sm:p-12 border-slate-200/90 shadow-2xl bg-white rounded-3xl space-y-6">
            ...
            {submitted ? (
              <div className="text-center py-12 space-y-4">
                ...
                <h2 className="text-3xl font-extrabold text-slate-950">Thank you!</h2>
                <p className="text-slate-700 text-base font-bold">We've received your request.</p>
                <p className="text-slate-600 text-xs max-w-md mx-auto leading-relaxed font-normal">
                  Our team will contact you within 24 hours using the email you provided (<span className="font-bold text-slate-900">{formData.workEmail}</span>).
                </p>
                <Button onClick={() => setSubmitted(false)} variant="outline" className="text-xs mt-6 font-bold px-6 py-2.5">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="space-y-4 pt-2">
                  ...
                  <div>
                    ...
                    >
                      <option value="Starter Reddit Campaign ($400 Per Campaign)">Starter Reddit Campaign ($400 Per Campaign)</option>
                      <option value="Growth & Launch Campaign ($600 Per Campaign)">Growth & Launch Campaign ($600 Per Campaign)</option>
                      <option value="Enterprise Reddit Campaign ($1000 Per Campaign)">Enterprise Reddit Campaign ($1000 Per Campaign)</option>
                    </select>
                  </div>
